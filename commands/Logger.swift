...
final class Logger {
    ...
    private let logQueue = DispatchQueue(label: "com.company.intune4mac.logger")
    ...
    private func getLogDirectory() -> URL {
        ...
        return paths[0].appendingPathComponent("Intune4Mac/Logs")
    }
    ...
    private func deviceInfo() -> String {
        ...
        do {
            ...
            print("Error getting Mac model: \(error)")
        }
        ...
        // Get macOS Version
            ...
            do {
                ...
                print("Error getting macOS version: \(error)")
            }
